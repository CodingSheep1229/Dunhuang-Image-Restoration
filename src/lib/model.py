...
class PConvUNet(nn.Module):
    ...
    def forward(self, input, input_mask):
        ...
        for i in range(self.layer_size, 0, -1):
            ...
            orig_h_shape = h_dict[enc_h_key].shape
            orig_h_mask_shape = h_mask_dict[enc_h_key].shape
            h = F.interpolate(h, scale_factor=2, mode=self.upsampling_mode)[:,:,:orig_h_shape[2],:orig_h_shape[3]]
            h_mask = F.interpolate(
                h_mask, scale_factor=2, mode='nearest')[:,:,:orig_h_mask_shape[2],:orig_h_mask_shape[3]]
